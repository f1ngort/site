document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateScore() {
        ...
        setTimeout(() => {
            ...
            if (percentage >= 85) {
                resultMessage.textContent = 'Отличный результат! Вы полностью готовы к работе.';
            } else if (percentage >= 60) {
                resultMessage.textContent = 'Хороший результат, но есть над чем поработать.';
            } else {
                resultMessage.textContent = 'Необходимо повторить материал и пройти тест снова.';
            }
