    ...
    if (!isset($_SESSION['user_id'])) {
        ...
        try {
            ...
            $data = [
                ...
                'fn' => $_SESSION['user_fn'] ?? '',
                'sn' => $_SESSION['user_sn'] ?? '',
                'zayavk' => 'Желает приобрести GEELY Preface',
                'status' => 'Новая',
...
<head>
    ...
    <title>Автоцетр Колесо - GEELY</title>
    ...
    <main>
        ...
        <section class="Description">
            ...
            <p class="DescriptionText">
                Geely — это китайская автомобильная компания, основанная в 1986 году. Компания быстро выросла и стала одним из крупнейших автопроизводителей Китая. Geely известна своими доступными и современными автомобилями, а также активным развитием электромобилей и гибридных моделей. В 2010 году Geely приобрела шведский бренд Volvo, что значительно повысило её международный статус и технологии. Сегодня Geely активно расширяется на мировом рынке, инвестируя в инновации и экологичные технологии.
            </p>
            <p class="Descriptionlink">Телефон <span>+73532405000</span></p>
            <div class="DescriptionPhoto">
                <ul class="DescriptionUl">
                    <li><img src="./images/geely_1.1.jpg" alt="" width="320" height="300"></li>
                    <li><img src="./images/omoda_2.jpg" alt="" width="320" height="300"></li>
                    <li><img src="./images/geely_1.2.jpg" alt="" width="320" height="300"></li>
                </ul>
            </div>
        </section>
        <section class="Catalog geely">
            <div>
                <h3 class="title-omoda-next">Preface</h3>
                <p class="omoda-sub-next">От 3 099 990 ₽</p>
                <p class="CatalogText omoda-next">Geely Preface — это элегантный седан бизнес-класса, подчёркивающий статус своего владельца. Его отличают впечатляющий дизайн, просторный и комфортабельный салон, а также отличные динамические характеристики.</p>
